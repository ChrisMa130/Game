...
namespace MG
{
    ...
    public static class GameDefine
    {
        ...
        public static readonly float LineSize = 0.15f;
        public static readonly float DisableLineLiveTime = 2.0f;
        public static readonly float ForbiddenLineAddLen = 0.3f;
        public static readonly float ForbiddenLineAddWidth = 0.1f;
